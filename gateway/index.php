...
<body>
    ...
    <div class="payment-box" style="width: 100%;border:none;">

        <h5 class="ms-3 fw-bold mt-5">Payment</h5>

        <h5 class="ms-3 mt-5 fs-6 fw-bold">Card Details</h5>

        <div class="input-group mb-3 ms-3 mt-4" style="width: 92%; height: 50px;">
            <input type="text" class="form-control" placeholder="card number">
        </div>

        <div class="d-flex flex-row mx-3 mt-5">
            <div class="input-group mb-3" style="width: 100%;">
                <input type="text" class="form-control" placeholder="Expariy Date">
            </div>

            <div class="input-group mb-3 ms-3" style="width: 100%; height: 50px;">
    ...
    <!--payment details-->
    <div class="text-center mx-3 mt-5 mb-5">
        <h4 class="text-secondary">All Payment Are Secured</h4>
        <div class="d-flex flex-row justify-content-center mt-3 gap-3">
            ...
            <img width="48" height="48" src="https://img.icons8.com/color/48/rupay.png" alt="rupay" style="margin-top: -10px;" />
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 48 48">
